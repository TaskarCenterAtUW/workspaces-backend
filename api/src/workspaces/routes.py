...
async def get_workspace(
    ...
    try:
        workspace = await service.get_workspace(current_user.projectGroups, workspace_id)
        return workspace
    except Exception as e:
...
async def create_workspace(
    ...
    try:
        workspace = await service.create_workspace(current_user.projectGroups, workspace_data)
        return workspace
    except Exception as e:
...
async def update_workspace(
    ...
    try:
        workspace = await service.update_workspace(current_user.projectGroups, workspace_id, workspace_data)
        return workspace
    except Exception as e:
