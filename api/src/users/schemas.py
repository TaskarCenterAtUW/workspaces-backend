...
class SetRoleRequest(SQLModel):
    ...
    @classmethod
    def privileged_roles_only(cls, v: WorkspaceUserRoleType) -> WorkspaceUserRoleType:
        if v == WorkspaceUserRoleType.CONTRIBUTOR:
            raise ValueError("cannot assign implicit role 'contributor' directly")
        return v
